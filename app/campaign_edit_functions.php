...
class WPeMatico_Campaign_edit_functions {
	...
	public static function rewrite_box( $post ) { 
		...
		if(!($campaign_rewrites)) $campaign_rewrites = array('origin'=>array(''),'title'=>array(false),'regex'=>array(false),'rewrite'=>array(''),'relink'=>array(''));
		?>
	...
	public static function word2cats_box( $post ) { 
		...
		if(!($campaign_wrd2cat)) $campaign_wrd2cat = array('word'=>array(''),'regex'=>array(false),'w2ccateg'=>array(''),'cases'=>array(false));
		?>
